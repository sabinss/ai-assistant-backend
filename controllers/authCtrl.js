    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <p>Dear User,</p>
          <p> ${isReset ? " You have requested to reset your password Please use the following token to proceed:" : "Thank you for singing up for Instwise! To complete your registration, please use the following token ."}. </p>
